              ...
              <div className="px-4 py-2 flex flex-col xl:flex-row gap-4">
                ...
                <div className="w-full xl:w-64 flex flex-col shrink-0 gap-3">
                  <div className="bg-card border border-theme rounded-xl flex flex-col shadow-sm overflow-hidden h-full min-h-[300px]">
                    <header className="p-3 border-b border-theme bg-[var(--bg-main)]/50 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <i className="fa-solid fa-clipboard-list text-[10px] text-muted"></i>
                        <span className="text-[9px] font-black uppercase text-main tracking-widest">Tactical Buffer</span>
                      </div>
                      <Badge variant="slate" className="text-[7px]">{scratchpadTasks.length}</Badge>
                    </header>
                    <div className="p-2 flex-1 overflow-y-auto space-y-1.5 custom-scrollbar bg-card">
                      ...
                      {scratchpadTasks.map(task => (
                        ...
                        >
                          <div className="flex items-start gap-2">
                            ...
                            <span className={`text-[10px] font-bold leading-tight ${task.status === TaskStatus.DONE ? 'line-through text-muted/50' : 'text-main'}`}>{task.title}</span>
                          </div>
