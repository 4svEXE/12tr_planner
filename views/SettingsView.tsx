            ...
            {isGuest ? (
              ...
              <form onSubmit={handleSendFeedback} className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full py-5 rounded-[1.5rem] font-black uppercase tracking-[0.2em] text-[11px] transition-all shadow-xl flex items-center justify-center gap-3 ${feedbackSent
