  ...
  return (
    <div className="h-screen flex bg-[var(--bg-main)] overflow-hidden relative">
      <div className="flex-1 flex flex-col min-w-0 h-full">
        <header className="p-6 md:p-10 bg-[var(--bg-card)] border-b border-[var(--border-color)] shrink-0">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <section className="space-y-4">
                <div className="flex justify-between items-center px-2">
                   <Typography variant="tiny" className="font-black uppercase tracking-widest text-[9px]">Дисципліна (Звички)</Typography>
                   <button onClick={() => setActiveTab('habits')} className="text-[8px] font-black text-orange-600 uppercase hover:underline">Усі звички</button>
                </div>
